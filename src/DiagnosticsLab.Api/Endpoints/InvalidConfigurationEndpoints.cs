...
/// <summary>
/// Maps endpoints for invalid configuration scenarios.
/// </summary>
public static class InvalidConfigurationEndpoints {
    /// <summary>
    /// Adds invalid configuration diagnostics endpoints to the endpoint route builder.
    /// </summary>
    public static IEndpointRouteBuilder MapInvalidConfigurationEndpoints(this IEndpointRouteBuilder endpoints) {
        var group = endpoints.MapGroup("/09-invalid-configuration");
