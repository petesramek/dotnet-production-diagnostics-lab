...
public sealed class ApiSmokeTests(DiagnosticsLabWebApplicationFactory factory) : IClassFixture<DiagnosticsLabWebApplicationFactory> {
    ...
    [InlineData("/04-missing-dependency-timeouts/problem?country=CZ", HttpStatusCode.OK)]
    [InlineData("/04-missing-dependency-timeouts/mitigation?country=CZ", HttpStatusCode.OK)]
