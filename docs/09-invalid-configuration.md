...
## Source files
- Endpoint: `src/ProductionDiagnosticsLab.Api/Endpoints/InvalidConfigurationEndpoints.cs`
- Tests: `tests/ProductionDiagnosticsLab.Tests/Scenarios/ConfigurationTests.cs`
